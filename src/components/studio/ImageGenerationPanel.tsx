...
const ImageGenerationPanel: React.FC<ImageGenerationPanelProps> = ({ onGenerate }) => {
    ...
    return (
        <div className="h-full flex flex-col bg-studio-bg-light dark:bg-studio-bg p-6 space-y-6">
            {/* Header */}
            ...
            <div className="text-center">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 text-xs font-semibold rounded-full">
